<?php
/**
 * Included copy of https://github.com/FoxyCart/FoxyCart-Cart-Validation--PHP
 *
 * Uses PR from
 * https://github.com/FoxyCart/FoxyCart-Cart-Validation--PHP/pull/17
 * to fix issue with empty option values.
 */
