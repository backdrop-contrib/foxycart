...
<p>After the module is installed and configured, you can start creating links for your products so they can be added to the user's cart.  Details for creating product links can be found <a href="http://wiki.foxycart.com/getting_started:adding_links_and_forms">here on the foxycart.com wiki</a>.  These links and form inputs can be added directly to a Backdrop content page using the "Full HTML" input format.</p>
