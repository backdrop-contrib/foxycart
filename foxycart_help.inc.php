...
$output = <<<EOD
<p>After installing the FoxyPal module, visit the FoxyCart Admin Configuration page.  Select Administer -&gt; FoxyCart -&gt; Settings.</p>

<h2>Drupal Blocks</h2>
<p>There are two blocks supplied by the FoxyPal module that display the cart status to the user.  Configuration for these can be found under Administer -&gt; Blocks.  These blocks can also be themed by overriding the foxycart-full-block and foxycart-summary-cart-bock templates.</p>
